...
*	TIMER -> Delay Microseconds e Milisseconds
*
* 	Como a memória do timer interno dá overflow em 65535 e cada contagem acontece em 1 microsegundo, o timer dá um overflow a cada 65.535 milisegundos, portanto:
*	Cicles    = (tempo * 1000)/ 65535 (DIVISÃO INTEIRA)
* 	lastClock = (tempo * 1000)% 65535 (RESTO DA DIVISÃO)
